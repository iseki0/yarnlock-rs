...
mod tests {
    ...
    fn test_tokenize0() {
        ...
        let expected = vec![
            TokenWrapper { col: 0, line: 1, token: Comment(" THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.\r".as_bytes()) },
            TokenWrapper { col: 65, line: 1, token: NewLine },
            TokenWrapper { col: 0, line: 2, token: Comment(" yarn lockfile v1\r".as_bytes()) },
